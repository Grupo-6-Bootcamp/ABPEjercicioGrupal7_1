    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fecha', models.DateField(auto_now_add=True)),
                ('direccion_despacho', models.CharField(verbose_name=100)),
                ...
                ('wishlist_idwishlist', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='principal.wishlist')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pedido_idpedido', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='principal.pedido')),
                ('productos_idproducto', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='principal.producto')),
            ],
            options={
